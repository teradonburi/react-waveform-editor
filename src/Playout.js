import { FADEIN, FADEOUT, createFadeIn, createFadeOut } from './lib/fade-maker'
...
export default class Playout {
  ...
  isPlaying = () => this.source !== undefined
  getDuration = () => this.buffer.duration
  ...
  setUpSource() {
    ...
    // used for solo/mute
    this.shouldPlayGain = this.audioContext.createGain()
